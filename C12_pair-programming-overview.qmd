...
![In pair programming two students work on one computer: Driver operates the computer, while Navigator helps them to find problems and offers advice.](/chapters/images/C12_pair-programming-overview_two_students.png ""){#fig-C12_pair-programming-overview_two_students fig-alt="Drawing of two students practicing pair programming - only one is typing on a computer. They talk to each other." width=70%}
...
![Students swap roles frequently to have experience of driving and navigating](/chapters/images/C12_pair-programming-overview_keyboard_switch.png ""){#fig-C12_pair-programming-overview_keyboard_switch fig-alt="Drawing of two students opracticing pair programming - only one is typing on a computer. They talk to each other. Then they swap who holds the keyboard." width=70%}
...
All you'll need to start is: a willing colleague or friend; two hours of time; and a simple programming task (maybe a challenge from [Tidy Tuesday](https://github.com/rfordatascience/tidytuesday), or [Advent of Code](https://adventofcode.com). You could even come to one of our taster sessions which we run at conferences and such, where we pair you up with another participant, we give you something to do and let you Pair Program! You can find instructions on how to run such a workshop by yourself on our [website](https://github.com/teaching-programming/pair-programming-r-workshop).
