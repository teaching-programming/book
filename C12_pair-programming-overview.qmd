...
#TODO: Photo of the authors while recording the podcast.
...
#TODO: Add image showing the concept of pair programming
...
![Students swap roles frequently to have experience of driging and navigating](/chapters/images/C12_pair-programming-overview_keyboard_switch.png ""){fig-alt="Drawing of two students opracticing pair programming - only one is typing on a computer. They talk to each other. Then they swap who holds the keyboard." width=70%}
...
#TODO: Add image showing something about pair programming
...
![In online pair programming instructors continuously roam between breakout rooms, prioritising those with raised hands. Instructions take 'ownership' of parts of 'the room'. When instructor enters a breakout room, they first ask students to describe the problem and what was already tried. After that instructor will gives help students.](/chapters/images/C12_pair-programming-overview_keyboard_switch.png){fig-alt="Drawing of an online breakout room setup. There are speech bubbles showing teacher converses with students. Arrows show teachers jumping between brekaout rooms." width=70%}
...
**Interviewer:** This sounds like very useful advice and first steps! And if people want to know more, they can find out about it on the website of our community, which is at <www.pairprogramming.ed.ac.uk>! Thanks for talking to me today. I am Dr Kasia Banas, and I've been talking today with Dr Brittany Blankinship and Dr Pawel Orzechowski from the Edinburgh Medical School at the University of Edinburgh.
