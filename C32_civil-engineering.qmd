...
**Math**                                                                 
 ...
 U_{cr} = \left\{                                                    
 \begin{array}{ll}                                                   
 {0.19} \, (d_{50})^{0.1} \log_{10}\left(\frac{4h}{d_{90}}\right) &  
 \text{for } \;  0.1 \le d_{50} \le 0.5 \text{  mm}; \\              
 {8.5} \, (d_{50})^{0.6} \log_{10} \left(\frac{4h}{d_{90}} \right) & 
 \text{for } \; {0.5} \le d_{50} \le 2 \text{ mm};                   
 \end{array}                                                         
 \right.                                                                                                                           
 $$                                                                                                                               
...
![Lattice 1](/chapters/images/ch32-lattice1.png){#fig-ch32-lattice1 fig-alt="A lattice with dots organised in 2 rows and 4 columns."}
...
![Lattice 2](/chapters/images/ch32-lattice2.png){#fig-ch32-lattice2 fig-alt="A lattice with dots organised in 2 rows and 4 columns, with the 2 left dots, the 4 central dots, and the 2 right dots grouped together."}
