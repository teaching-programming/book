...
![The Rubik's Cube of Assessment](/chapters/images/C35-rubiks-cube.png "The Rubik's Cube of Assessment"){#fig-c35-rubiks-cube fig-alt="A partially solved Rubik’s Cube at the centre of the image, surrounded by icons representing higher education, such as: a university building, graduation cap, student figure, checklist, books, and graded paper. There are circular arrows indicating an interconnected and dynamic feedback system among the elements displayed." width=70%}
