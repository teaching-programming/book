...
![Figure 5. Pair programming and the analogy of a driver and a co-pilot #TODO (will be replaced with reworked image by TAM)](chapters/images/BLANK.png "Pair-programming"){fig-alt="A figure illustrating pair programming code, with a coder coding and a co-pilot checking the code, and the analogy is made with driving a car, with a driver and a co-pilot." width=70%} 
