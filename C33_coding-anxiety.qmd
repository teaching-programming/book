...
- name: Tiago A. Marques 
  ...
  corresponding: true
  affiliation: 
    - name: Departamento de Biologia Animal, Faculdade de Ciências da Universidade de Lisboa 
      city: Lisboa 
      country: Portugal 
    - name: Centre for Research into Ecological and Environmental Modelling, University of St Andrews 
      city: St Andrews
      country: Scotland 
- name: William P. Kay
  ...
  corresponding: false
  affiliation:
    - name: School of Biosciences, Cardiff University
      city: Cardiff
      country: Wales
- name: Christopher Aldous Oldnall
  ...
  corresponding: false
  affiliation:
    - name: School of Mathematics and Maxwell Institute for the Mathematical Sciences, University of Edinburgh
      city: Edinburgh
      country: UK
...
- name: Robert S. Young
  ...
  affiliation:
    - name: Edinburgh Medical School, University of Edinburgh
      city: Edinburgh
      country: UK
    - name: Zhejiang University - University of Edinburgh (ZJE) Institute
      city: Haining
      country: China
...
- name: Tiago A. Marques 
  email: tiago.marques@st-andrews.ac.uk 
  corresponding: true
  affiliations: Departamento de Biologia Animal, Faculdade de Ciências da Universidade de Lisboa; Centre for Research into Ecological and Environmental Modelling, University of St Andrews 
- name: William P. Kay
  email: kayw@cardiff.ac.uk
  corresponding: false
  affiliations: School of Biosciences, Cardiff University
- name: Christopher Aldous Oldnall
  email: chris.oldnall@ed.ac.uk
  affiliations: School of Mathematics and Maxwell Institute for the Mathematical Sciences, The University of Edinburgh; Edinburgh Medical School, The University of Edinburgh
- name: Chris Sutherland
  email: css6@st-andrews.ac.uk
  affiliations: Centre for Research into Ecological and Environmental Modelling, University of St Andrews
- name: Robert S. Young
  email: robert.young@ed.ac.uk
  affiliations: Edinburgh Medical School, The University of Edinburgh; University of Edinburgh (ZJE) Institute, Zhejiang University
:::
...
![An example of a humorous cartoon that normalises coding anxiety. (https://www.thesquarecomics.com/)](chapters/images/C33_coding-anxiety_humour.png){#fig-c33-humour fig-alt="A cartoon with four images. In the first three characters say 'We may look different', in 2nd it says 'We may code using different programming languages', in the 3rd 'but inside us we have one thing in common', and in the 4th 'Imposter Syndrome'." width=70%}

Given anxiety's negative feedback loop, the best way to combat anxiety is to break this vicious cycle (@fig-c33-cycle). As an instructor or teacher, this can be achieved by providing positive experiences with coding[^C33-foot2]. Importantly, after acknowledging that coding anxiety is real, the solutions to it should be presented along with how overcoming their anxiety will be supported, e.g., reflecting on personal experience. Offering your experiences and providing a very visible role could serve as a powerful catalyst for students to realise they can overcome their own coding anxiety too.
...
![The cycle of anxiety. Coding is identified as the trigger and the teacher serves as a diffuser to intervene in multiple places and in multiple ways to break the cycle. Adapted from https://www.mentalyc.com/](chapters/images/C33_coding-anxiety_cycle.png){#fig-c33-cycle fig-alt="A representation of the anxiety cycle, highlight the places wher the teacher can act to break it." width=70%}
...
![Pair programming and the analogy of a driver and a co-pilot](chapters/images/C33_coding-anxiety_pair.png "Pair-programming"){#fig-c33-pair-programming fig-alt="A figure illustrating pair programming code, with a coder coding and a co-pilot checking the code, and the analogy is made with driving a car, with a driver and a co-pilot." width=70%} 
