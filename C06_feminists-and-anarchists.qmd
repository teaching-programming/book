...
We do acknowldge, however, the tensions between anarchism and the realities of the higher education systems to which we belong, and the risk of coming across as having an inauthentic, opportunistic take on anarchist ideas and practices. Admitedly, we operate (and, arguably, succeed) within a system that is not as flexible, self-governing, or non-hierarchical as the one we are taking inspiration from. Still, we believe incremental, practical changes are a possible way of moving towards more inclusive and democratic realities.   
