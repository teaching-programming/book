...
TODO keep? which is followed in @sec-resourcetable by a list of additional tools that can serve as starting points for working with sound and code.
...
![Two examples of arrays becoming sound and music. On the left, the array is translated into note values. On the right, the array is translated directly to an audio file.](/chapters/images/C17_fig1_arrays_as_sound_and_music.svg){#fig-arrays-as-music width=70% fig-alt="Left image: a command to create an array of numbers, above a representation of a MIDI score and a traditional music score. Right image: another command to create an array of numbers, above a plot of a single period of a sin wave."}
...
::: {#fig-python-piano layout="[60, 40]" layout-valign="bottom"}
...
TODO: keep this, or do we have everything linked and referenced in the text?
...
An incomplete list of software and software libraries for exploring music and sound in coding contexts.
