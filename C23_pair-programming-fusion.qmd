---
title: "Learning Together Across Modes: Online and On-site Pair Programming in a Hybrid / Fusion Course"
...
In this chapter, we want to share our experience of developing and teaching an experimental and innovative pair programming course.[^C23-course-definition] This course is non-traditional; we teach text mining to master's level students in fusion mode (occurring in a highly technologised classroom designed for teaching online and on-site students as a single cohort to involve all students as fully as possible)[^C23-fusion-teaching] in a two-day intensive session. We knew this would be challenging, but we also knew that this would be a great learning experience and a chance to do things differently. We present here an honest reflection of the trials, tribulations, and wins in what was ultimately a rewarding and satisfying experience. We didn’t do everything perfectly, but we learned a lot, and we believe the students did too. Please read on and hopefully enjoy hearing about our experience.
...
[^C23-course-definition]: At the University of Edinburgh a "course" is usually a block of teaching (5-10 weeks) on a subject with assessment at the end, which awards academic credits. In your institution this might be called differently, e.g. class, subject, module or topic.
[^C23-fusion-teaching]: See [QAA Scotland - Examples of good practice](https://www.qaa.ac.uk/scotland/development-projects/planning-and-delivery-active-blended-learning/section-five-examples-of-good-practice)
...
![Different modes of paired students working together on programming exercises.](/chapters/images/C23_pair-programming-fusion-modes.png "Modes"){#fig-fusion-modes fig-alt="Different modes of paired students working together on programming exercises." width=70%}
...
While students generally preferred mixed-mode pairs (see @fig-noisy) and reported feeling more connected to the broader cohort, this arrangement proved exhausting to both online and on-site participants. The background noise in the classroom, combined with the additional cognitive load students experienced as a result of this noise, can leave them feeling drained by the end of a session.

![Mixed-mode pair programming in action with noise in background.](/chapters/images/C23_pair-programming-fusion-noisy-background.png "Mixed mode pairs"){#fig-noisy fig-alt="Mixed mode pair programming in action with noise in the background." width=70%}
...
For our fusion course, we could not find a tool which would deliver exactly what we needed at the time, so we used a shared digital whiteboard. The whiteboard would always start with several empty scales, and each student would be invited to type the letter X in the appropriate place on the whiteboard (see @fig-feedback). Since we gathered this feedback every 1-2 hours of the course (after each badge), we had very granular data about the two days of our course. In the animation below, you can see the way the mood in the room changed as the course progressed, which was very useful for us to see and respond to.

::: {.content-visible unless-format="html"}
![Feedback collected at the end of each badge.](/chapters/images/C23_pair-programming-fusion-relentless-feedback-gif.png "Final feedback"){#fig-feedback fig-alt="Drawing with a number of axis on which students give feedback. Feedback for about 10 students is annotated. Categories include 'was it hard' and 'did you learn a lot'" width=70%}
:::
::: {.content-visible when-format="html"}
![Feedback collected at the end of each badge.](/chapters/images/C23_pair-programming-fusion-relentless-feedback-gif.gif "Final feedback"){#fig-feedback fig-alt="Drawing with a number of axis on which students give feedback. Feedback for about 10 students is annotated. Categories include 'was it hard' and 'did you learn a lot'" width=70%}
:::


For completeness, this technique is not limited only to online or hybrid environments, as we also tried it on in-person bootcamp courses as a means of gathering and sharing feedback in the room (@fig-example-feedback).

![Feedback collected during a one-day intensive course on Hands-on Data Visualisation within Edinburgh Medical School at the University of Edinburgh.](/chapters/images/C23_pair-programming-fusion-relentless-feedback-sharpie.png "Example feedback"){#fig-example-feedback fig-alt="Feedback collected during a one-day intensive course on Hands-on Data Visualisation within Edinburgh Medical School at the University of Edinburgh." width=70%}


### Chat Blast and Other Micro-contributions
...
At specific points in the course, we also asked all students to type a quick, micro contribution into the chat all at the same time, i.e. a Chat Blast (see @fig-chat-blast), to encourage engagement and shared participation.  We took the Three Stars and A Wish approach, which is used by teachers in primary schools to help pupils focus on what is working and what needs improving [@larson2008continuous]. In our case, we flipped this around and asked students to provide us with “Three stars and a wish” about the course in the chat of the video call. This enabled them to share their thoughts not only on what they liked about the course but also gave them permission to point out things that could be improved or things they struggled with.

![Chat blast with feedback using the “Three stars and a wish” method.](/chapters/images/C23_pair-programming-fusion-chat-blast.png "Chat blast."){#fig-chat-blast fig-alt="Chat blast with feedback using the “Three stars and a wish” method." width=70%}
