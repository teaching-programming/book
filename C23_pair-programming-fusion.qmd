...
![Figure 1: Different modes of paired students working together on programming exercises.](/chapters/images/C23_pair-programming-fusion-modes.png "Modes"){fig-alt="Different modes of paired students working together on programming exercises."}
...
![Figure 2: Mixed-mode pair programming in action with noise in background.](/chapters/images/C23_pair-programming-fusion-noisy-background.png "Mixed mode pairs"){fig-alt="Mixed mode pair programming in action with noise in the background."}
...
![Figure 3: The ghost helper effect.](/chapters/images/C23_pair-programming-fusion-ghost-helper.png "Ghost helper effect"){fig-alt="The ghost helper effect."}
...
![Figure 4: Feedback collected at the end of each badge.](/chapters/images/C23_pair-programming-fusion-relentless-feedback-gif.png "Final feedback"){fig-alt="Feedback collected at the end of each badge."}
...
![Figure 6: Chat blast with feedback using the “Three stars and a wish” method.](/chapters/images/C23_pair-programming-fusion-chat-blast.png "Chat blast."){fig-alt="Chat blast with feedback using the “Three stars and a wish” method."}
