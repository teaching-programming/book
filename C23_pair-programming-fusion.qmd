...
![Figure 1: Different modes of paired students working together on programming exercises.](/chapters/images/Cxx_yourimagefile.png "Modes"){fig-alt=" Different modes of paired students working together on programming exercises."}
...
![Figure 2: Mixed-mode pair programming in action with noise in background.](/chapters/images/Cxx_yourimagefile.png "Mixed mode pairs"){fig-alt="Mixed mode pair programming in action with noise in the background."}
...
![Figure 3: The ghost effect.](/chapters/images/Cxx_yourimagefile.png "Ghost effect"){fig-alt="The ghost effect."}
...
![Figure 4: Feedback collected at the end of each badge.](/chapters/images/Cxx_yourimagefile.png "Final feedback"){fig-alt="Feedback collected at the end of each badge."}
...
![Figure 6: Chat blast with feedback using the “Three stars and a wish” method.](/chapters/images/Cxx_yourimagefile.png "Chat blast."){fig-alt="Chat blast with feedback using the “Three stars and a wish” method."}
