...
author:
  ...
  - name: Yanina Bellini Saibene
    ...
    affiliations: rOpenSci; RLadies+; Universidad Austral
...
author:
  ...
  - name: Yanina Bellini Saibene
    email: yabellini@gmail.com
    affiliations: rOpenSc; RLadies+; Universidad Austral
:::
...
![Different approaches to translating teaching materials: from professional services to platforms and customized workflows.](/chapters/images/C24_Fig_1.png "Different approaches to translating teaching materials"){#fig-C24_Fig_1 fig-alt="Different approaches to translating teaching materials depending on the output that needs to be generated and the aims of the translation project. Three main approaches are outlined: professional translators, translation management platforms, and tailored solutions, with examples given for each."}
:::
::: {.content-visible when-format="html"}
![Different approaches to translating teaching materials: from professional services to platforms and customized workflows.](/chapters/images/C24_Fig_1.svg "Different approaches to translating teaching materials"){#fig-C24_Fig_1 fig-alt="Different approaches to translating teaching materials depending on the output that needs to be generated and the aims of the translation project. Three main approaches are outlined: professional translators, translation management platforms, and tailored solutions, with examples given for each."}
:::
