...
| CivEng                                                                  | CompSci                                                  |
|-------------------------------------------------------------------------|----------------------------------------------------------|
| * Paradigms: imperative, procedural                                     | * Paradigm: object-oriented                              |
| * Object type: concrete, physically meaningful                          | * Object type: abstract, blueprint to generate instances |
| * Action: math and logic operations applied to parameters of the object | * Action: objects’ methods invoked on instances.         |
