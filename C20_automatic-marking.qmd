...
In addition to test cases, there are many adjustments that can be made, as can be seen in @fig-config. The most important ones --- Question type, Precheck, Check and Penalty, Customisation, Template, and Support Files --- are described in this section. Other options are also available in CodeRunner, and we recommend consulting the [CodeRunner documentation](https://trampgeek.github.io/moodle-qtype_coderunner/) for detailed information.
...
**Recommendation**: See the [CodeRunner documentation](https://trampgeek.github.io/moodle-qtype_coderunner/) on supporting or implementing new languages.
...
The Template configuration can be significantly more complex. See the Moodle XML file [`CodeRunnerConstruct.xml`](/chapters/resources/C20_CodeRunnerConstruct.xml) for an example.
