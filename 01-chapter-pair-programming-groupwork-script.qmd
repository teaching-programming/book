...
!["Let's run this code and see what happens", "The error says we forgot to load the package at the start!", "Yay, we did it! It works!"](/chapters/images/pairprog_chapter_driver_speaks.png "Example things the Driver could say."){fig-alt="Drawing of two students pair programming together using one keyboard. The student holding a keyboard says something."}
...
!["There's a bracket missing on line 7", "Interesting! Could you tell me more about why we're doing it this way?", "I just checked in the documentation, and we're missing the second argument here."](/chapters/images/pairprog_chapter_navigator_speaks.png "Example things the Navigator could say."){fig-alt="Drawing of two students pair programming together using one keyboard. The student who is not holding a keyboard says something."}
...
!["Hello! Who's the driver right now?", "When was the last time you switched drivers? Is it time now?", "Do you need any help, or are you just cracking on?"](/chapters/images/pairprog_chapter_tutor_helps.png "Tutor is helping a group of students."){fig-alt="Tutor is approaching a pair of students. Speech bubble shows tutor talking. Students are in the process of passing a keyboard to each other."}
...
!["what if I end up in a pair with someone who is mean, or much more advanced than me?", "I hate socially complex situations, will I know how to behave?", "would it be easier if I always work with the same friend, or would I miss out on meeting new people, and learning new coding styles", "I’m worried I might not know what to say or do in a group..."](/chapters/images/pairprog_chapter_group_anxiety.png "Anxiety about being part of a group"){fig-alt="Visibly anxious is saying something, with a group of other students in the background"}
...
!["I see another way to solve this!", "Oh I never thought about it this way"](/chapters/images/pairprog_chapter_online_ideas.png "Exchange of Ideas between online students."){fig-alt="Drawing of group of students on an online call. Speech bubbles show that students are saying things."}
