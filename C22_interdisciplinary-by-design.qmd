...
[^footnote-cdcs]: Founded in 2019, CDCS is a strategic initiative of the College of Arts, Humanities and Social Sciences at the University of Edinburgh.  Since 2021 it has been part of the [Edinburgh Futures Institute](https://www.efi.ed.ac.uk), one of five innovation hubs established through the [Data-Driven  Innovation Programme](https://ddi.ac.uk/) funded by the [Edinburgh and South East Scotland City Region Deal](https://esescityregiondeal.org.uk/).  Alongside its training programme, CDCS offers events, technical services and infrastructure for data-led research.

[^footnote-dmm]: For each meeting, we also prepare a [Markdown file](https://github.com/DCS-training/Digital-Method-of-the-Month) that provides attendees with starting notes to support their work on a specific method.

[^footnote-fellows]: The Training Fellows are recruited annually (with the possibility of extending their contract) through an open call to current PhDs and ECRs, and through a standard interview panel. Once appointed, they are offered a Guaranteed Hours contract.
