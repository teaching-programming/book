...
Over the past two years, I’ve been experimenting with new teaching techniques for my second-year students, having them share roles while tackling Excel data analysis or collaborating on map creation in QGIS. Looking back now, I realise I was using pair programming [@TeachProgAcross_C36] (two students working together on one computer) all along, unaware of its formal framework or established structure. It had emerged from my imagination during those late Sunday night planning sessions, born out of necessity and intuition.
...
![Students in their pair programming roles](/chapters/images/C37_pair-programming-sruc-pairs.jpg){#fig-c37-pairs fig-alt="Two pairs of students on their driver and co-pilot roles ready to start the challenge."}
...
![Digital clock on the whiteboard showing the 15 minutes intervals.](/chapters/images/C37_pair-programming-sruc-clock.jpg){#fig-c37-clock fig-alt="Times counting down from 15 minutes displayed on a projector in a classroom."}
...
![Group of first year students in the middle of their pair programming challenge.](/chapters/images/C37_pair-programming-sruc-class.jpg){#fig-c37-class fig-alt="Number of pairs of students on their driver and co-pilot roles ready to start the challenge."}
