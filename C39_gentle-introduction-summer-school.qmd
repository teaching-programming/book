...
![Laptop stickers from the summer school, including the pair-programming proficiency badge](/chapters/images/C39_gentle-introduction-summer-school-laptop-sticker.jpg){#fig-c39-laptop-sticker  fig-alt="photo of stickers on a laptop. One sticker says 'Text and Data Analysis DCS Summer School'." }
...
![Instructors and some of the attendees of the CDCS summer school Gentle Introduction to Coding](/chapters/images/C39_gentle-introduction-summer-school-attendees.jpg){#fig-c39-attendees  fig-alt="Photo of summer school participants taken on a summer day in a park in front of a university building in Edinburgh" }
...
![Graph showing student attitudes over first 4 days of the summer school.](/chapters/images/C39_gentle-introduction-summer-school-feedback-days.png){#fig-c39-feedback-days  fig-alt="Graph showing student feedback over 5 days of the course. Answers to 5 questions are shown. Visible trend is that over time things were getting more difficult, but students keep finding it useful, learn a lot and enjoy working in pairs."}
...
![Examples of badges that students could achieve during the summer school.](/chapters/images/C39_gentle-introduction-summer-school-badges-list.png){#fig-c39-badges-list  fig-alt="Picture with small stickers badges showing a number of topics of the course, like 'writing code, running code, for loops repeat things'" }
...
![Components of each badge are: slides, coding exercises and self-reflection mini-diary.](/chapters/images/C39_gentle-introduction-summer-school-badges-structure.png){#fig-c39-badges-structure  fig-alt="Drawing showing the structure of each badge. It shows an equation with a badge made of lecture video, coding exercises with tasks, and a short student reflection."}
...
![Feedback from students about components of the course on a scale 1-5.](/chapters/images/C39_gentle-introduction-summer-school-feedback-course.png){#fig-c39-feedback-course  fig-alt="Graph showing student setisfaction with the event. Most measures show average scores of 4 or more on a scale 1 to 5." }
