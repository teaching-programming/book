...
::: {.callout-note appearance="simple" title="Disclaimer"}
This article is written like an annoying food blog: it starts with a [wishy-washy poetic blurb](#poetic-intro) which you will probably scroll past anyway; followed by [the actual recipe, details and process](#summer-school-details); just to finish with some [practical recommendations](#practical-tips) the author may or may not have been paid to include... (Also I will overuse punctuation (coders do that)). Enjoy\!
:::

![Laptop stickers from the summer school, including the pair-programming proficiency badge](/chapters/images/C39_gentle-introduction-summer-school-laptop-sticker.jpg){fig-alt="TODO" }
...
![instructors and some of the attendees of the CDCS summer school Gentle Introduction to Coding](/chapters/images/C39_gentle-introduction-summer-school-attendees.jpg){fig-alt="TODO" }
...
![When two students use pair-programming: 'the driver' (left) is a person who types, 'the navigator' (right) is their companion, as they solve a problem together](/chapters/images/C39_gentle-introduction-summer-school-pair-programming.png){fig-alt="TODO" }

Throughout the summer school, students submitted frequent 'relentless' feedback \[TODO link to hybrid chapter\] in the form of short bullet points about what resonated with them \[TODO link to 3s1w chapter\].
...
![graph showing student attitudes over first 4 days of the summer school](/chapters/images/C39_gentle-introduction-summer-school-feedback-days.png){fig-alt="TODO" }

Cross-pollinating ideas in pair programming works surprisingly well in diverse groups (btw. ‘pear’ is spelled differently than ‘pair’, but did you know that if two pear trees exchange pollen they will have more and healthier fruit?). Each partner brings their own background, metaphors and ways of understanding, while also experiencing someone else’s ways. All learning during the summer school happened with partners, who we changed every 2 hours. That meant that the diversity of skills and backgrounds worked to our advantage, as it led to spreading of good practice and also allowed people to meet with each other.

If you’d like to know more about Pair programming, join our special interest group ([https://pairprogramming.ed.ac.uk/](https://pairprogramming.ed.ac.uk/)) or read more about how to introduce it into your classroom \[TODO: in-book ref or two\].

### Badges: Collect skills like Pokemons\!
...
![examples of badges that students could achieve during the summer school](/chapters/images/C39_gentle-introduction-summer-school-badges-list.png){fig-alt="TODO" }
...
![components of each badge are: slides, coding exercises and self-reflection mini-diary](/chapters/images/C39_gentle-introduction-summer-school-badges-structure.png){fig-alt="TODO" }
...
![graph showing students' self-perceived improvement in terms of skills before and after the summer-school, on scale from 0 to 5](/chapters/images/C39_gentle-introduction-summer-school-skills.png){fig-alt="TODO" }
...
!['Time Timer' is a large clock designed for primary schools which we used to indicate when driver and navigator should switch roles](/chapters/images/C39_gentle-introduction-summer-school-timer.jpg){fig-alt="TODO" }
...
8. [Noteable](https://noteable.edina.ac.uk/) is a fantastic online coding environment free for our students, built by the Edina team at our university. With it you can start coding in Python/R in minutes, and it works great with github. [^C39_gentle-introduction-summer-school-tech-support]
...
![graph showing feedback from students about components of the course on a scale 1-5](/chapters/images/C39_gentle-introduction-summer-school-feedback-course.png){fig-alt="TODO" }
