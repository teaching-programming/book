...
* **Real data suggestion**: [World Happiness Report](https://worldhappiness.report/) data from most countries around the world and different years can be used to aim to model the countries level of happiness based on various measured social elements. [Programme for International Student Assessment](https://www.oecd.org/en/about/programmes/pisa/pisa-data.html) data provides standardised exam scores for a large sample of students in different countries along with many social and educational indicators.  
...
* **Real data**: Pima Indian Diabetes dataset [@smith1988using] includes various health indicators to use in modelling to predict whether participants would develop diabetes. [Behavioral Risk Factor Surveillance System](https://www.cdc.gov/brfss/annual_data/annual_data.htm) data is available from several years and includes many health indicators and records of presence of many health conditions to use in different classification problems.    
